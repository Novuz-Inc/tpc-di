...
create or refresh streaming live table public_trade_stg_3
...
using delta 
as select
 _c0::DECIMAL(15) T_ID, _c1::TIMESTAMP T_DTS, _c2::string T_ST_ID,
 _c3::string T_TT_ID, _c4::INT T_IS_CASH, _c5::string T_S_SYMB,
 _c6::DECIMAL(6) T_QTY, _c7::DECIMAL(8, 2) T_BID_PRICE, _c8::DECIMAL(11) T_CA_ID,
 _c9::string T_EXEC_NAME, _c10::DECIMAL(8,2) T_TRADE_PRICE,
 _c11::DECIMAL(10, 2) T_CHRG, _c12::DECIMAL(10, 2) T_COMM, _c13::DECIMAL(10,2) T_TAX
from cloud_files(
                 --"s3://tpcdi-files/.*/tpcdi/sf=${tpcdi_scale}/Batch1/Trade[^HT]",
                 "s3://tpcdi-files/tmp/tpcdi/sf=1000/Batch1/Trade[^HT]",
                 "csv",
