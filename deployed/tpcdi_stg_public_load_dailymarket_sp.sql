...
create or refresh streaming live table public_dailymarket_stg_1
...
as select
 ...
 _c3::string DM_S_SYMB, _c4::DECIMAL(8, 2) DM_CLOSE, _c5::DECIMAL(8,2) DM_HIGH, 
 _c6::DECIMAL(8, 2) DM_LOW, _c7::INT DM_VOL
from cloud_files(
