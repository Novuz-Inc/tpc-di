...
create or refresh streaming live table public_cashtransaction_stg_2
...
from cloud_files(
                 --"s3://tpcdi-files/tmp/tpcdi/sf=${tpcdi_scale}/Batch[2-3]/CashTransaction",
                 "s3://tpcdi-files/tmp/tpcdi/sf=1000/Batch[2-3]/CashTransaction",
                 "csv",
